                    ...
                    <article class="article">
                      ...
                      <div class="article__info">
                        ...
                        <div class="article__info__meta">
                          ...
                          ?>
                          <small>Сategory: <a href="/articles.php?categorie=<?php echo $art_cat['id'];?>"><?php echo $art_cat['title']; ?></a></small>
                        </div>
        ...
        while ($comment = mysqli_fetch_assoc($comments))
        {
          ...
          <article class="article">
            ...
            <div class="article__info">
              ...
              <div class="article__info__preview"><?php echo $str = mb_strimwidth(strip_tags($comment['text']), 0, 70, "...");?></div>
            </div>
          </article>
                        ...
                        <div class="block__content">
                          <div class="articles articles__vertical">
                                      ...
                                      <?php
                                        ...
                                        $articlesSql[$i] = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categorie_id`= $i ORDER BY `views` LIMIT 1 ");
